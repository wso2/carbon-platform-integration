...
public class CarbonPackageManager {
    ...
    public String unzipCarbonPackage() throws ZipException {
        String carbonTempHome = ExtensionUtils.getCarbonTempLocation();
        String carbonHome;
        String carbonZipFileLocation = ExtensionUtils.getCarbonZipLocation();
