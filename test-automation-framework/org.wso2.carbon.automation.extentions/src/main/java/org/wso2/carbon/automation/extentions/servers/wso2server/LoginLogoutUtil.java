...
import org.wso2.carbon.automation.extentions.adminclients.AuthenticationAdminClient;
...
public final class LoginLogoutUtil {
    ...
    public String login(String domain, String userName, String password)
            throws LoginAuthenticationExceptionException, IOException, XMLStreamException, URISyntaxException, SAXException{
       // ExtentionUtills.setKeyStoreProperties();
