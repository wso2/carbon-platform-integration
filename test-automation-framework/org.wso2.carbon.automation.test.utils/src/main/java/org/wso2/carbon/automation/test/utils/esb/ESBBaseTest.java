...
public class ESBBaseTest {
    ...
    public ESBBaseTest(TestUserMode testUserMode) throws Exception {
        axis2Client = new StockQuoteClient();
        automationContext = new AutomationContext("ESB", testUserMode);
        esbUtils = new ESBTestCaseUtils();
    }
    ...
    public void updateESBConfiguration(OMElement synapseConfig) throws Exception {
        ...
        esbUtils.updateESBConfiguration(synapseConfig, automationContext.getContextUrls().getBackEndUrl(), automationContext.login());
    }

    public OMElement loadSampleESBConfiguration(String filePath)
            throws Exception {
