...
package org.wso2.carbon.automation.distributed.configurations;

import org.wso2.carbon.automation.distributed.context.ContextXpathConstants;
import org.wso2.carbon.automation.distributed.context.InstanceType;
...
public class UrlGenerationUtil {
    ...
    public static String getBackendURL(Instance instance) {
        String backendUrl;
        boolean webContextEnabled = instance.getProperties()
                .containsKey(ContextXpathConstants.PRODUCT_GROUP_WEBCONTEXT);
     ...
     */
    public static String getServiceURL(Tenant tenant, Instance instance, boolean isSecured)
            throws XPathExpressionException {
        String serviceURL;
        String port;
        String protocol;
        boolean webContextEnabled = instance.getProperties().containsKey(ContextXpathConstants
                                                                                 .PRODUCT_GROUP_WEBCONTEXT);
        ...
        if (tenant.getDomain().equals(AutomationConfiguration.
            ...
            if (portEnabled && webContextEnabled) {
                ...
                if (webContextRoot != null && port != null) {
                    ...
                    serviceURL = protocol + "://" + hostName + "/" + webContextRoot + "/" + "services/t/"
                                 + tenantDomain;
                }
            } else if (!portEnabled && webContextEnabled) {
                String webContextRoot = instance.getProperty(ContextXpathConstants.PRODUCT_GROUP_WEBCONTEXT);
