...
public class UserPopulateExtension implements ExecutionListenerExtension {
    ...
    public void onExecutionStart() throws Exception {
        for (Node aProductGroupsList : productGroupsList) {
            String productGroupName = aProductGroupsList.getAttributes().
                    getNamedItem(XPathConstants.NAME).getNodeValue();
    ...
    private String getProductGroupInstance(Node productGroup) throws Exception {
        ...
        Boolean isClusteringEnabled = Boolean.parseBoolean(productGroup.getAttributes().
                getNamedItem(XPathConstants.CLUSTERING_ENABLED).getNodeValue());
    ...
    private List<String> getInstanceList(Node productGroup, String type) {
        ...
        for (int i = 0; i < numberOfInstances; i++) {
            ...
            String instanceName = attributes.getNamedItem(XPathConstants.NAME).getNodeValue();
            String instanceType = attributes.getNamedItem(XPathConstants.TYPE).getNodeValue();
    ...
    private List<Node> getAllProductNodes() throws XPathExpressionException {
        ...
        NodeList productGroups = AutomationConfiguration.getConfigurationNodeList(XPathConstants.PRODUCT_GROUP);
